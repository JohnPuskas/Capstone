...
export default () => html`
  <section id="user-login-section">
    ...
    <div id="select-user" class="user-login">
      <form name="existingUser" onsubmit="">
  ...
  <section id="content">
    <article id="about-app" class="app-content">
      ...
      <p>
        ...
        <i>what</i> changes were made in <i>which</i> versions of a song within
        a song project? With Track Version Track, you can turn a confusing mess
        like this:
      </p>
      <img
        class="demo-image"
    ...
    <article class="app-content bottom-app-content">
      ...
      <ol>
        ...
        <li>
          <p>
            View the full version history and list of changes all in one place,
            and one page.
          </p>
        </li>
        <li>
